...
public class GmailProviderTest {
    ...
    void setUp() {
        ...
        try {
            org.springframework.test.util.ReflectionTestUtils.setField(gmailProvider, "SENDER", "sender@example.com");
        } catch (Exception e) {
            throw new RuntimeException(e);
        }

        testEmail = EmailRequest.builder()
                .to("test@example.com")
    ...
    void shouldThrowEmailSendException_WhenEmailSendingFails() throws IOException {
        ...
        EmailSendException ex = assertThrows(EmailSendException.class, () ->
                gmailProvider.sendEmail(testEmail)
        );
